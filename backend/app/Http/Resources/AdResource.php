...
class AdResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        $carsRootId = Category::query()->where('slug', 'cars')->value('id');
        $isVehicleCategory = $category !== null
            && $carsRootId !== null
            && in_array($category->id, Category::descendantIds((int) $carsRootId), true);
        ...
        return [
            ...
            'is_vehicle_category' => $isVehicleCategory,
            'city' => $city ? [
                'id' => $city->id,
