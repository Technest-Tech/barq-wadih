...
class CategoryFieldSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Real Estate fields ───────────────────────────────────────────────
        $apartmentsForSale = Category::where('slug', 'apartments-for-sale')->first();
        $apartmentsForRent = Category::where('slug', 'apartments-for-rent')->first();
        ...
        $realEstateFields = [
            [
                ...
                'options'         => json_encode([
                    ...
                    ['value' => 'studio',     'label_ar' => 'استوديو',     'label_en' => 'Studio'],
                    ['value' => 'duplex',     'label_ar' => 'دوبلكس',      'label_en' => 'Duplex'],
                ]),
            ],
            [
                'field_key'       => 'area_sqm',
                ...
                'is_filterable'   => true,
                'sort_order'      => 2,
                'validation_rules'=> json_encode(['min' => 1, 'max' => 99999]),
            ],
            [
                'field_key'       => 'bedrooms',
                'label_ar'        => 'غرف النوم',
                ...
                'sort_order'      => 3,
                'options'         => json_encode([
                    ['value' => '1',  'label_ar' => '1 غرفة',  'label_en' => '1 Bedroom'],
                    ['value' => '2',  'label_ar' => '2 غرفة',  'label_en' => '2 Bedrooms'],
                    ['value' => '3',  'label_ar' => '3 غرف',   'label_en' => '3 Bedrooms'],
                    ['value' => '4',  'label_ar' => '4 غرف',   'label_en' => '4 Bedrooms'],
                    ['value' => '5+', 'label_ar' => '5+ غرف',  'label_en' => '5+ Bedrooms'],
                ]),
            ],
            [
        ...
        foreach ([$apartmentsForSale, $apartmentsForRent] as $category) {
            if (! $category) {
                continue;
            }
            foreach ($realEstateFields as $field) {
                CategoryField::firstOrCreate(
                    ['category_id' => $category->id, 'field_key' => $field['field_key']],
                    array_merge($field, ['category_id' => $category->id])
                );
            }
        }
