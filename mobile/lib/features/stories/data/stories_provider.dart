...
final _demoStories = [
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/20.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/21.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/22.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/11.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/12.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/23.jpeg',
    ),
  ...
  StoryItem(
    ...
    imageUrl: AppConstants.normalizeImageUrl(
      'http://localhost:8000/storage/demo_ads/24.jpeg',
    ),
