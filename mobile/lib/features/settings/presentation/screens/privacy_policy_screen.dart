...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  static const _sections = <(String, String)>[
    ...
    (
      'حقوق المستخدم',
      'يحق لك الوصول إلى بياناتك الشخصية وتصحيحها أو حذفها في أي وقت من خلال إعدادات الحساب. كما يحق لك طلب نسخة من بياناتك أو الاعتراض على معالجتها لأغراض تسويقية عبر التواصل مع فريق الدعم.'
    ),
    (
